...
def initial_setup(root):
    set_background(root, file_path='src/images/world.jpeg')
...
def show_country_info(root):
    ...
    if current_continent == "Asia":
        ...
        if country.lower() == "japan":
            ...
            new_page_setup(root, image_file_path='src/images/japan.jpeg')
            ...
            new_page_setup(root, image_file_path='src/images/china.jpeg')
            rating_function(root)
            add_review_input(root, current_country)
        ...
        if country.lower() == "germany":
            ...
            new_page_setup(root, image_file_path='src/images/germany.jpeg')
            rating_function(root)
            add_review_input(root, current_country)
            ...
            new_page_setup(root, image_file_path='src/images/poland.jpeg')
            rating_function(root)
            add_review_input(root, current_country)
        ...
        if country.lower() == "australia":
            ...
            new_page_setup(root, image_file_path='src/images/australia.jpeg')
            rating_function(root)
            add_review_input(root, current_country)
            ...
            new_page_setup(root, image_file_path='src/images/new_zealand.jpeg')
            rating_function(root)
            add_review_input(root, current_country)
        ...
        if country.lower() == "usa":
            current_country = "USA"
            new_page_setup(root, image_file_path='src/images/usa.jpeg')
            rating_function(root)
            add_review_input(root, current_country)
            ...
            new_page_setup(root, image_file_path='src/images/mexico.jpeg')
            rating_function(root)
            add_review_input(root, current_country)
        ...
        if country.lower() == "brazil":
            ...
            new_page_setup(root, image_file_path='src/images/brazil.jpeg')
            rating_function(root)
            add_review_input(root, current_country)
            ...
            new_page_setup(root, image_file_path='src/images/bolivia.jpeg')
            rating_function(root)
            add_review_input(root, current_country)
        ...
        if country.lower() == "zambia":
            ...
            new_page_setup(root, image_file_path='src/images/zambia.jpeg')
            rating_function(root)
            add_review_input(root, current_country)
            ...
            new_page_setup(root, image_file_path='src/images/rwanda.jpeg')
            rating_function(root)
            add_review_input(root, current_country)
...
def asia(root):
    ...
    new_page_setup(root, image_file_path='src/images/asia.jpeg')
...
def europe(root):
    ...
    new_page_setup(root, image_file_path='src/images/europe.jpeg')
    # Add input box for country names
    entry = tk.Entry(root)
    entry.place(x=250, y=200)
    # Add button to show country information
...
def australia(root):
    ...
    new_page_setup(root, image_file_path='src/images/australia_c.jpeg')
    # Add input box for country names
    entry = tk.Entry(root)
    entry.place(x=250, y=200)
    # Add button to show country information
...
def namerica(root):
    ...
    # remove redundant components
    new_page_setup(root, image_file_path='src/images/namerica.jpeg')
...
def samerica(root):
    ...
    # remove redundant components
    new_page_setup(root, image_file_path='src/images/samerica.jpeg')
...
def africa(root):
    ...
    # remove redundant components
    new_page_setup(root, image_file_path='src/images/africa.jpeg')
